...
from modelTraining import train_and_evaluate_model, save_model, save_metrics
...
if __name__ == "__main__":
    ...
    X, y, scaler, label_encoder, features = prepare_dataset(stock_data, tickers, window_size)
    ...
    results, trained_model = train_and_evaluate_model(X, y, create_classification_model, class_weights=class_weights)
    ...
    save_model(trained_model, scaler, label_encoder, 'artifacts')
    print("Model and metrics saved to 'artifacts' directory.")
    ...
    top_stocks = predict_top_stocks(trained_model, recent_data, scaler, label_encoder, features, window_size)
